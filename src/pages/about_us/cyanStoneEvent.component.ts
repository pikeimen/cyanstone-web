...
@Component({
	selector: 'cyanStoneEvent',
    templateUrl: './tpl/cyanStoneEvent.tpl.html',
    directives:[HdComponent,FtComponent,SubMenuComponent],
    styleUrls:[
        '../../assets/css/about_us/cyan.stone.event.css',
        '../../assets/css/about_us/chairman.word.css'
    ]
})
export class CyanStoneEventComponent implements OnInit{
     menus : SubMenu[];
